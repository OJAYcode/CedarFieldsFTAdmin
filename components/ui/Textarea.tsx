    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ref={ref}
          className={cn(
            "w-full px-4 py-3 border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-accent-600 focus:border-accent-600 transition-all duration-300 resize-vertical bg-white",
            error
